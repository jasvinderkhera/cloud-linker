            ...
            <div className="row">
                ...
                <div className="col-md-6 my-md-1 my-5 d-flex justify-content-center align-items-center">
                  <div>
                    ...
                    <input type="email" placeholder='Email' className="form-control mb-4 py-2 px-4" />
                    <input type="password" placeholder='Password' className="form-control mb-4 py-2 px-4" />
                   </form>
